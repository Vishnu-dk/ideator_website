          ...
          <div className="w-full  my-auto md:w-[50%] ">
            ...
            >
              {projects.map((project, index) => {
                ...
                <WorkSliderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-0  xl:mx-auto  z-30 w-full justify-between xl:w-max xl:jutify-none "
