  ...
  return (
    ...
    >
      <div className="container mx-auto  h-full">
        <div className="flex flex-col md:flex-row md:gap-[30px] mx-auto text-left bg-base1 bg-opacity-50  py-2 rounded-lg">
                  ...
                  <SwiperSlide key={index} className="w-full ">
                    <div className="h-1/2   w-full mx-auto flex justify-center items-center ">
                      ...
                      <div className=" w-full h-[250px] ">
                        <Image src={list.img} fill className="object-contain -z-10" />
                      </div>
                    </div>
                  </SwiperSlide>
                );
